...
import selLogo from "../../Assets/software-europe-white.png";
...
const Landing = () => {
  ...
  return (
    ...
    >
      <Box>
        <img alt="ram logo" src={ram} width="150px" />
      </Box>
      <Button
        onClick={() => push("/newagenda")}
        variant="contained"
        size="large"
      ...
      <Box display="flex" justifyContent="space-around">
        ...
        <img alt="sel logo" src={selLogo} width="250px" />
      </Box>
    </Box>
  );
};
